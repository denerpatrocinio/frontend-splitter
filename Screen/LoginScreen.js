...
//Setting my atributes and making my validations
const LoginScreen = ({navigation}) => {
  ...
  const handleSubmitPress = () => {
    ...
    //Calling my API controller to login my user and making validations
  ...
  //Creating my textinput by the user and button to let it log in
  //Also adding style to my textinput, button backgrounds
  return (
...
//Creating my style sheet to design my page and control size, padding, alignment and borders.
