...
//Creating attributes to register a new user by text input and button 
const RegisterScreen = (props) => {
  ...
  const handleSubmitButton = () => {
    ...
    //Calling my API controller to register a new user and making validations
  ...
  if (isRegistraionSuccess) {
    ...
    // Making text input, button background styles 
    return (
      <View
        style={{
          flex: 1,
...
//Creating my styles sheets for register text input, button, alignment, padding and colors
